package cn.edu.hqu.javaee.chapter4_4.controller;
...
import cn.edu.hqu.javaee.chapter4_4.Chapter44Application;
import cn.edu.hqu.javaee.chapter4_4.controller.formEntity.LoginForm;
import cn.edu.hqu.javaee.chapter4_4.controller.formEntity.RegisterForm;
import cn.edu.hqu.javaee.chapter4_4.entity.Hquer;
import cn.edu.hqu.javaee.chapter4_4.service.HquerService;
		...
		if (errors.hasErrors())
			...
			if (!hquerService.register(hquer)) {
				...
				Files.copy(registerForm.getPicFile().getInputStream(),
						Paths.get(Chapter44Application.ROOT, hquer.getUserName() + ".jpeg"),
